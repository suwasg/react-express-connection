...
const Shipping = () => {
  ...
  const [shipping_address1, setShippingAddress1]=useState(shippingInfo.shipping_address1 || "" )
  const [shipping_address2, setShippingAddress2]=useState(shippingInfo.shipping_address2 || '')
